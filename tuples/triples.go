...
// Pack3 packs three values into a 3-tuple.
...
// FirstOf3 returns the first value from a 3-tuple.
func FirstOf3[T1, T2, T3 comparable](v1 T1, v2 T2, v3 T3) T1 { return v1 }

// SecondOf3 returns the second value from a 3-tuple.
func SecondOf3[T1, T2, T3 comparable](v1 T1, v2 T2, v3 T3) T2 { return v2 }

// ThirdOf3 returns the third value from a 3-tuple.
